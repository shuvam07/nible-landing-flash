...
const ShareButtons = ({ url, title, variant = "icon" }: ShareButtonsProps) => {
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      {open && (
        <div className="absolute right-0 bottom-full mb-1 bg-white border border-border rounded-lg shadow-lg p-1.5 z-50 flex items-center gap-1">
          {shareLinks.map((link) => (
            <a
              key={link.name}
              href={link.href}
